...
class PostPagesTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.follower = Follow.objects.create(
            author=cls.author, user=cls.non_author
        )
        cls.image = (
        ...
        cls.uploaded = SimpleUploadedFile(
            name="smallVIEWS.png", content=cls.image, content_type="image/png"
        )
    ...
    def test_post_edit_correct_template_non_author(self):
        ...
        template_pages = {
            "posts/create_post.html": POST_EDIT_PAGE,
        }
        for template, reverse_name in template_pages.items():
            with self.subTest(reverse_name=reverse_name):
    ...
    def test_edit_show_correct_context(self):
        ...
        response = self.author_client.get(POST_EDIT_PAGE)
        form_field = {
            "text": forms.fields.CharField,
            "group": forms.fields.ChoiceField,
            "image": forms.fields.ImageField,
...
class FollowTest(TestCase):
    ...
    def test_subscription_available_authorize(self):
        ...
        self.follower.get(reverse("posts:profile_follow", args=[self.author]))
    ...
    def test_self_follow(self):
        ...
        self.follower.get(reverse("posts:profile_follow", args=[self.user]))
        self.assertEqual(Follow.objects.count(), counter)
